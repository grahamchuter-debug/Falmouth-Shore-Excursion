...
(function () {
  ...
  function wireMobileNav() {
    ...
    if (!panel) {
      ...
      panel.className = 'lg:hidden hidden border-t border-pr-100 bg-white px-4 py-3';
      panel.innerHTML =
        '<div class="flex flex-col gap-3 text-sm font-medium">' +
        '<a href="/" class="py-2 text-gray-700 hover:text-ocean-600">Home</a>' +
        '<a href="/best-falmouth-shore-excursions" class="py-2 text-gray-700 hover:text-ocean-600">Shore Excursions</a>' +
        '<a href="/best-beaches-near-falmouth-jamaica" class="py-2 text-gray-700 hover:text-ocean-600">Best Beaches</a>' +
        '<a href="/martha-brae-river-rafting-guide" class="py-2 text-gray-700 hover:text-ocean-600">Martha Brae</a>' +
        '<a href="/falmouth-port-guide" class="py-2 text-gray-700 hover:text-ocean-600">Port Guide</a>' +
        '<a href="/one-day-in-falmouth-from-a-cruise-ship" class="py-2 text-gray-700 hover:text-ocean-600">One Day</a>' +
